<section class="property" id="property">
  <div class="container">
    ...
    <p class="section-subtitle">Espacios</p>

    <h2 class="h2 section-title">Nuestros Espacios</h2>
          ...
          <div class="card-footer">
            ...
            <div class="card-author">
              ...
              <figure class="author-avatar">
                <img src="./assets/images/rafael.jpg" alt="William Seklo" class="w-100">
              </figure>

              <div>
                <p class="author-name">
                  <a href="#">Rafael General</a>
                </p>

                <p class="author-title">Gerente General</p>
              </div>
        ...
        <div class="property-card">
          ...
          <div class="card-footer">
            ...
            <div class="card-author">
              ...
              <figure class="author-avatar">
                <img src="./assets/images/rafael.jpg" alt="rafael" class="w-100">
              </figure>

              <div>
                <p class="author-name">
                  <a href="#">Rafael Aguirre</a>
                </p>
          ...
          <div class="card-footer">
            ...
            <div class="card-author">
              ...
              <div>
                ...
                <p class="author-title">Gerenten General</p>
              </div>
